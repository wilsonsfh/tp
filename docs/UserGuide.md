...
* `find n/ Betsy` followed by `updatetask 2 1 2025-12-12 23:59` sets the due date for the first task of the second person in the results of the `find` command to be **2025-12-12 23:59**.
